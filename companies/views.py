...
def export_limited(request):
  ...
  include_fields = ['is_active', 'is_payroll', 'payment_method', 'client_file_number', 'client_name', 'company_reg_number', 'company_auth_code', 'remarks', 'director_name', 'director_phone_number', 'director_email', 'UTR', 'NINO', 'HMRC_agent', 'vat']

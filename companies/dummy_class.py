...
class SelfemploymentIncomeAndExpensesDataCollectionAuthFormForClients:
        def __init__(self, *args, **kwargs) -> None:
                pass

class SelfemploymentIncomeAndExpensesDataCollectionCreationFormForClients:
        def __init__(self, *args, **kwargs) -> None:
                pass

class SelfemploymentIncomeAndExpensesDataCollectionCreationForm:
        def __init__(self, *args, **kwargs) -> None:
                pass

class SelfemploymentIncomeAndExpensesDataCollectionUpdateForm:
        def __init__(self, *args, **kwargs) -> None:
                pass

class SelfemploymentIncomeAndExpensesDataCollectionDeleteForm:
        def __init__(self, *args, **kwargs) -> None:
                pass
...
class MergedTrackerCreateionForm:
        def __init__(self, *args, **kwargs) -> None:
                pass
...
class LimitedVATTrackerCreationForm:
        def __init__(self, *args, **kwargs) -> None:
                pass

class LimitedVATTrackerChangeForm:
        def __init__(self, *args, **kwargs) -> None:
                pass

class LimitedVATTrackerDeleteForm:
        def __init__(self, *args, **kwargs) -> None:
                pass

class LimitedConfirmationStatementTrackerCreationForm:
        def __init__(self, *args, **kwargs) -> None:
                pass

class LimitedConfirmationStatementTrackerChangeForm:
        def __init__(self, *args, **kwargs) -> None:
                pass

class LimitedConfirmationStatementTrackerDeleteForm:
        def __init__(self, *args, **kwargs) -> None:
                pass

...
# uk_tax = ProgressiveTaxPolicy(year_22_23, personal_allowance_limit=100000)



# incomes = [-20000, 10000, 20000, 50000, 75000, 80000, 110000, 130000, 180000, 200000, 300000]
...
#     print('income', income, 'total_tax', total_tax, 'uk_tax', uk_tax_amount, 'class_2_tax',class_2_amount, 'class_4_tax', class_4_amount)
